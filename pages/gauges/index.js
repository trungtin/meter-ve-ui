      ...
      {account && account.address ? (
        ...
        <Paper className={classes.notConnectedContent}>
          ...
          <Typography className={classes.mainDescNC} variant="body2">
            Earn Rewards. Providing liquidity to these LP’s allows you to hedge
            against USD risk, or simply have exposure in your own preferred
            currency, while earning LP incentives.
          </Typography>
          <Button
            disableElevation
